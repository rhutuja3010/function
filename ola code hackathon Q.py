print("WELCOME TO OLA TRAVELS")
current_location=input("enter the location")
droping_point=input("enter the droping point")
nearby_riders=[["Name=Raj","cab=auto","he is ready to go for prise=200","min=15min"],
               ["Name=Yash","cab=mini","he is ready to go for prise=300","min=1/2hour"],
               ["Name=Ram","cab=prime","he is ready to go for prise=100","min=1hour"]]
riders_details=[["HR28DQ55","White","9234567890"],
                ["KL2158924","Gray","7076543210"],
                ["MH240DS","Black","9062465623"]]
for i in range(len(nearby_riders)):
    print(nearby_riders[i])
if current_location=="pune":
    print("Raj is avaliable")
elif current_location=="kataraj":
    print("Ram and Yash avaliable for this ride")
